...
// );
''',
  'unrelated-sublist-plus-related-list-icons':
      r'''// SearchAnchorPicker<Person>(
//   config: peopleConfig(
//     relatedListItemStatusOf: (person) => PickerRelatedListItemStatus(
...
// );
''',
  'unrelated-parent-change-nested-independent':
      r'''// SearchAnchorPicker<Person>(
//   config: peopleConfig(title: 'People'),
//   initialSelectedIds: selected.toList(),
//   onChange: (delta) { /* write selected */ },
...
''',
  'hidden-selected':
      r'''        initialSelectedItemCache: /*bold=on*/ _passSelectedItemCache
            ? peopleIn(_selected)
            : null, /*bold=off*/
...
/*bold=on*/return switch (_hiddenMode) {
